...
function PANEL:addOption(val)
    ...
    self.options[iteration].Paint = function(s,w,h)
        ...
        draw.RoundedBoxEx((self.lastchild == s or (self.poppedOut and isFirst)) and 8 or 0, 0, 0, w, h, s:IsHovered() and maincolor_5 or maincolor_10, isFirst, isFirst, !isFirst, !isFirst)
