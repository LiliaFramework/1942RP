...
local function UnstuckPlayer(pl)
    ...
    if ply:IsStuck() then
        ...
        for i = 1, 10 do
            ...
            if not FindPassableSpace(1, forward, SearchScale * i) and not FindPassableSpace(2, right, SearchScale * i) and not FindPassableSpace(3, right, -SearchScale * i) and not FindPassableSpace(4, up, SearchScale * i) and not FindPassableSpace(5, up, -SearchScale * i) and not FindPassableSpace(6, forward, -SearchScale * i) then
                ok = false
            end
