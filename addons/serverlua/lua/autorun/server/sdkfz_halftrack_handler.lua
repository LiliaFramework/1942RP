...
util.AddNetworkString( "sdkfz_halftrack_register_tank" )
util.AddNetworkString( "sdkfz_halftrack_tank_do_effect" )
util.AddNetworkString( "sdkfz_halftrack_update_tracks" )
...
sound.Add( {
	...
	level = 140,
	pitch = { 90, 110 },
	sound = "^simulated_vehicles/weapons/valentine_mki.wav"
} )
sound.Add( {
	name = "valentine_at_fire",
	channel = CHAN_STATIC,
	volume = 1.0,
	level = 140,
	pitch = { 90, 110 },
	sound = "^simulated_vehicles/weapons/valentine_at.wav"
} )
sound.Add( {
	name = "churchill_mk_vii_fire_mg",
	channel = CHAN_STATIC,
	volume = 1.0,
	level = 110,
	pitch = { 90, 110 },
	sound = "^simulated_vehicles/weapons/mg_fire.wav"
} )
sound.Add( {
