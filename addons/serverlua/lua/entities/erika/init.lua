...
self.Entity:EmitSound("axis/erika.mp3",500)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Erika activated")
end
...
self.Entity:StopSound("axis/erika.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Erika deactivated")
