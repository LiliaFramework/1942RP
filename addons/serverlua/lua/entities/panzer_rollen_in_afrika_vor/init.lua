...
local ent = ents.Create( "panzer_rollen_in_afrika_vor" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("axis/panzer_rollen_in_afrika_vor.mp3",500)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Panzer Rollen in Afrika vor activated")
end
...
self.Entity:StopSound("axis/panzer_rollen_in_afrika_vor.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Panzer Rollen in Afrika vor deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Panzer Rollen in Afrika vor removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
