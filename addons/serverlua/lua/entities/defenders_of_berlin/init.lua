...
local ent = ents.Create( "defenders_of_berlin" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("axis/defenders_of_berlin.mp3",500)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Defenders Of Berlin activated")
end
...
self.Entity:StopSound("axis/defenders_of_berlin.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Defenders Of Berlin deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Defenders Of Berlin removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
