...
local ent = ents.Create( "sieg_heil_viktoria" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("axis/sieg_heil_viktoria.mp3",500)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Sieg Heil Viktoria activated")
end
...
self.Entity:StopSound("axis/sieg_heil_viktoria.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Sieg Heil Viktoria deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Sieg Heil Viktoria removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
