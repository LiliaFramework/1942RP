...
local ent = ents.Create( "koniggratzer_march" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("axis/koniggratzer_march.mp3",500)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Königgrätzer March activated")
end
...
self.Entity:StopSound("axis/koniggratzer_march.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Königgrätzer March deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Königgrätzer March removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
