...
local ent = ents.Create( "the_british_grenadiers" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("allies/the_british_grenadiers.mp3",500)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "The British Grenadiers activated")
end
...
self.Entity:StopSound("allies/the_british_grenadiers.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "The British Grenadiers deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "The British Grenadiers removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
