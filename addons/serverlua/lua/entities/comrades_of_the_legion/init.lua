...
local ent = ents.Create( "comrades_of_the_legion" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("allies/comrades_of_the_legion.mp3",500)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Comrades Of The Legion activated")
end
...
self.Entity:StopSound("allies/comrades_of_the_legion.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Comrades Of The Legion deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Comrades Of The Legion removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
