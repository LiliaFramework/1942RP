...
local ent = ents.Create( "republic_sanka" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("allies/republic_sanka.mp3",500)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Republic Sanka activated")
end
...
self.Entity:StopSound("allies/republic_sanka.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Republic Sanka deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Republic Sanka removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
