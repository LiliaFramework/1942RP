...
local ent = ents.Create( "blood_on_the_risers" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("allies/blood_on_the_risers.mp3",500)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Blood On The Risers activated")
end
...
self.Entity:StopSound("allies/blood_on_the_risers.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Blood On The Risers deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Blood On The Risers removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
