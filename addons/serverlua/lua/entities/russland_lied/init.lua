...
local ent = ents.Create( "russland_lied" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("axis/russland_lied.mp3",500)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Russland Lied activated")
end
...
self.Entity:StopSound("axis/russland_lied.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Russland Lied deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "Russland Lied removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
