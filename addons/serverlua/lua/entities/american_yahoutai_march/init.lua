...
local ent = ents.Create( "american_yahoutai_march" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("allies/american_yahoutai_march.mp3",500)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "American Yahoutai March activated")
end
...
self.Entity:StopSound("allies/american_yahoutai_march.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "American Yahoutai March deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "American Yahoutai March removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
