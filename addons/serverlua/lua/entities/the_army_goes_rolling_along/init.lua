...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/speakers/speakers/speaker_medium.mdl")
...
local ent = ents.Create( "the_army_goes_rolling_along" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("allies/the_army_goes_rolling_along.mp3",500)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "The Army Goes Rolling Along activated")
end
...
self.Entity:StopSound("allies/the_army_goes_rolling_along.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "The Army Goes Rolling Along deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "The Army Goes Rolling Along removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
