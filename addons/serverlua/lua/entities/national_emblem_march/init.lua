...
local ent = ents.Create( "national_emblem_march" )
ent:SetPos( SpawnPos )
ent:Spawn()
ent:Activate()
return ent
...
self.Entity:EmitSound("allies/national_emblem_march.mp3",500)

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "National Emblem March activated")
end
...
self.Entity:StopSound("allies/national_emblem_march.mp3")

for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "National Emblem March deactivated")
...
for k,ply in pairs(player.GetAll()) do
ply:ChatPrint( "National Emblem March removed")
ply:SendLua([[RunConsoleCommand("stopsound")]])
end
