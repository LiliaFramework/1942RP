...
if SERVER then
    function ENT:Initialize()
        self:SetModel(hook.Run("GetMoneyModel", self:getAmount()) or nut.config.get("moneyModel", "models/props_lab/box01a.mdl"))
    ...
    function ENT:onDrawEntityInfo(alpha)
        ...
        drawText(nut.currency.get(self:getAmount()), x, y, colorAlpha(configGet("color"), alpha), 1, 1, nil, alpha * 0.65)
    end
end
