...
----------------------------------------------------------------------------------------------
net.Receive("cmenu_tying", function(len, ply)
    netstream.Start(ply, "startcmenutying")
end)
----------------------------------------------------------------------------------------------
net.Receive("cmenu", function(len, ply)
    netstream.Start(ply, "startcmenu")
end)
----------------------------------------------------------------------------------------------
net.Receive("liaApproveID", function(len, ply)
