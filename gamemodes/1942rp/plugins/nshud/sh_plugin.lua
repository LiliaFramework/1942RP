...
function PLUGIN:DrawEntityInfo(entity, alpha, position)
    ...
    if description ~= entity.nutDescCache then
        ...
        entity.nutDescLines = nut.util.wrapText(description, ScrW() * 0.5, "nutSmallFont")
    end
    ...
    for i = 1, #charInfo do
        ...
        _, ty = drawText(info[1]:gsub("#", "\226\128\139#"), x, y, colorAlpha(info[2] or color_white, alpha), 1, 1, "nutSmallFont")
        y = y + ty
    end
end
