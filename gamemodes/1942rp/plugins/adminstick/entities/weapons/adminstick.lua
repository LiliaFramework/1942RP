...
local usergroups = {"root", "superadmin", "communitymanager", "headadmin", "headgm", "senioradmin",}
...
function SWEP:DrawWorldModel()
    if not usergroups[self:GetOwner():GetUserGroup()] and self:GetOwner():GetMoveType() == MOVETYPE_NOCLIP then return end
    self:DrawModel()
end