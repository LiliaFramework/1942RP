...
nut.config.add("backgroundURL", "", "The URL or HTML for the background of the character menu.", nil, {
    category = PLUGIN.name
})

nut.config.add("charMenuBGInputDisabled", true, "Whether or not KB/mouse input is disabled in the character background.", nil, {
    category = PLUGIN.name
})
